...
--
CREATE DATABASE IF NOT EXISTS `microbloh` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `microbloh`;
...
CREATE TABLE `noticias` (
  ...
  `calendario` datetime DEFAULT NULL,
  `imagem` varchar(100) NOT NULL,
  `tipo` enum('admin','editor') DEFAULT NULL,
